...
- (LeftChannelCollectionView *)leftChannelCollectionView{
    ...
    if (!_leftChannelCollectionView) {
        ...
        _leftChannelCollectionView = [[LeftChannelCollectionView alloc]initWithFrame:CGRectMake(Screen_with/6, 64, Screen_with - SliderWith - Screen_with/6,Screen_heigh - 64)];
